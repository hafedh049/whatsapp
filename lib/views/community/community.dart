...
import 'package:whatsapp/views/community/start_community.dart';
    ...
    return Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => const StartCommunity())),
            child: Container(
